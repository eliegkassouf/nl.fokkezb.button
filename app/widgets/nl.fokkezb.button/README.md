...
## The repository
The repository contains two branches. This master branch contains the widget. The other `app` branch has a complete Titanium Alloy demo project, including some optional external libs and assets:

* `app/lib`: The `fa.js` generated by [FontAwesomeJS](https://github.com/FokkeZB/FontAwesomeJS), used for mapping icon names to unicodes.
* `app/assets/fonts`: Thef [Font Awesome](http://fortawesome.github.com/Font-Awesome/) font.
